...
exports.SelectDisabledOptionsShowcase = void 0;
const react_1 = __importDefault(require("react"));
const react_native_1 = require("react-native");
const components_1 = require("@ui-kitten/components");
const SelectDisabledOptionsShowcase = () => {
    ...
    return (<components_1.Layout style={styles.container} level='1'>
      <components_1.Select selectedIndex={selectedIndex} onSelect={(index) => setSelectedIndex(index)}>
        ...
        <components_1.SelectItem disabled={true} title='Option 2'/>
        <components_1.SelectItem title='Option 3'/>
      </components_1.Select>
    </components_1.Layout>);
};
exports.SelectDisabledOptionsShowcase = SelectDisabledOptionsShowcase;
const styles = react_native_1.StyleSheet.create({
    container: {
        minHeight: 128,
    },
});
//# sourceMappingURL=selectDisabledOptions.component.js.map