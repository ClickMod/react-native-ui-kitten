...
class DateFnsService extends components_1.NativeDateService {
    ...
    format(date, format) {
        if (date) {
            return (0, format_1.default)(date, format || this.options.format, this.options.formatOptions);
        }
        return '';
    }
    parse(date, format) {
        return (0, parse_1.default)(date, format || this.options.format, new Date(), this.options.parseOptions);
    }
    getId() {
        return 'date-fns';
    }
